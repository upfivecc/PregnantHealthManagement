...
-- 插入更多预约数据
INSERT INTO appointments (user_id, doctor_id, appointment_time, status, remark) VALUES 
(5, 1, '2025-12-10 09:00:00', 1, '常规产检'),
(6, 2, '2025-12-11 10:30:00', 0, '首次产检'),
(7, 2, '2025-12-12 14:00:00', 1, 'B超检查'),
(8, 3, '2025-12-13 15:30:00', 2, '产前咨询'),
(3, 1, '2025-12-15 09:30:00', 0, '营养咨询'),
(5, 1, '2025-12-20 11:00:00', 3, '因故取消');
